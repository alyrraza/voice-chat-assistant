...
function App() {
  ...
  async function handleAudioBlob(blob) {
    ...
    try {
      const res = await fetch('/api/backend?action=transcribe', {
        method: 'POST',
  ...
  async function sendMessage(text) {
    ...
    try {
      const chatRes = await fetch('/api/backend?action=chat', {
        method: 'POST',
      ...
      const speakRes = await fetch('/api/backend?action=speak', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
